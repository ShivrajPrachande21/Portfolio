    ...
    return (
        <div className="pb-4 lg:mb-36">
            <div className="flex justify-around flex-wrap lg:flex-row-reverse">
                ...
                <div className="w-full lg:w-1/2">
                    <motion.div initial='hidden' animate='visible' variants={containerVariants} className="flex pt-10 flex-col items-center lg:items-start mt-10">
                        <motion.h2 variants={childVariants} className="pb-6  text-4xl tracking-tighter lg:text-7xl">
                            Shivraj Prachande
                        </motion.h2>
